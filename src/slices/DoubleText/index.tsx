  ...
  return (
    ...
    >
      <div className="grid grid-cols-12 md:grid-cols-24 grid-flow-row auto-rows-max distance-top-3 distance-bottom-5">
        <div data-aos="fade-up" className="row-start-1 col-start-2 col-end-12 bg-white/30 text-style-11 text-black">
          <PrismicRichText field={slice.primary.headline} />
        </div>
        
        <div data-aos="fade-up" className="mt-1 row-start-1 col-start-2 md:col-start-13 col-end-12 md:col-end-24 bg-white/30 text-style-6 text-text-gray-on-white ">
