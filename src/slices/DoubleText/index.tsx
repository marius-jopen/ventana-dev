  ...
  return (
    ...
    >
      <div className="grid grid-cols-12 md:grid-cols-24 grid-flow-row auto-rows-max pt-12 md:pt-20 2xl:pt-28 pb-28 md:pb-32 2xl:pb-48">
        ...
        <div data-aos="fade-up" className="md:mt-1 row-start-2 md:row-start-1 col-start-2 md:col-start-13 col-end-12 md:col-end-24 bg-white/30 text-style-6 text-text-gray-on-white ">
