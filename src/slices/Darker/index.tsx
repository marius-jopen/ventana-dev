  ...
  return (
    <section className="bg-black text-white">
      <div className="grid grid-cols-12 md:grid-cols-24 grid-flow-row auto-rows-max">
        ...
        <div className="row-start-3 col-start-2 col-end-12 md:col-end-17 text-right text-style-5 text-text-gray-on-black distance-bottom-5">
          <PrismicRichText field={slice.primary.sub_headline} />
        </div>

        <div className="row-start-4 col-start-2 md:col-start-5 col-end-12 text-center md:text-right text-style-8 text-text-gray-on-black distance-bottom-4">
